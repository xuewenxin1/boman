...
extern VOID app_light_on(VOID);
/***********************************************************
************************macro define************************
***********************************************************/

/* PID + PIN14/16 大小档：改 include/product_hw.h 里 LIGHT_HW_SHAPE */
...
uint8_t sleep_init[14] = {
    0x00, 0x03, 0x00, 0x01, 0x64, 0x01, 0x64, 0x64, 0x00, 0x00, 0x00, 0x17, 0x00, 0x00};
