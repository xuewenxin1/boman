...
static void calibration_apply_verify_output(void)
{
    ...
    UINT32_T duties[] = {5000, 5000, 5000, 5000, 0};
...
void calibration_process(void) {
...

    {
        ...
        if (rhythm_empty) {
            ...
            TAL_PR_NOTICE("calibration: rhythm was empty, restore default rhythm_sunlight1\r\n");
        }
    }
...
uint8_t system_init(void) {
    ...
    if (need_calibration) {
        TAL_PR_NOTICE("\r\n=== 进入校准模式 ===\r\n");
        // TAL_PR_NOTICE("提示: 未校准设备默认系数为100%%\r\n");
        
        // 阻塞式校准，直到校准完成
        calibration_process();
        
        // TAL_PR_NOTICE("=== 校准模式结束 ===\r\n");
        // TAL_PR_NOTICE("系统将继续初始化...\r\n");
