 ...
 * @return none
 */
STATIC VOID_T __sw_i2c_start(SW_I2C_GPIO_T i2c_pin)
{
    I2C_SCL_H();
    I2C_SDA_H();
    I2C_DELAY(DELAY_US);
 ...
 * @return none
 */
STATIC VOID_T __sw_i2c_stop(SW_I2C_GPIO_T i2c_pin)
{
    I2C_SCL_L();
    I2C_SDA_INIT_OUT();
 ...
 * @return none
 */
STATIC VOID_T __sw_i2c_ack(SW_I2C_GPIO_T i2c_pin)
{
    I2C_SCL_L();
    I2C_SDA_INIT_OUT();
 ...
 * @return none
 */
STATIC VOID_T __sw_i2c_no_ack(SW_I2C_GPIO_T i2c_pin)
{
    I2C_SCL_L();
    I2C_SDA_INIT_OUT();
 ...
 * @return none
 */
STATIC BOOL_T __sw_i2c_get_ack(SW_I2C_GPIO_T i2c_pin, UINT_T flags)
{
    ...
    if (0 == (flags & SW_I2C_FLAG_IGNORE_NACK)) {
        while (I2C_SDA_READ()) {
            if (timeout_count >= DELAY_US) {
                ...
                // TAL_PR_NOTICE("wait ack timeout");
                return FALSE;
            }
            I2C_DELAY(1);
            timeout_count++;
 ...
 * @return none
 */
STATIC VOID_T __sw_i2c_send_byte(SW_I2C_GPIO_T i2c_pin, UCHAR_T data)
{
    UCHAR_T i = 0;
 ...
 * @return operation result
 */
STATIC VOID_T __sw_i2c_init(SW_I2C_GPIO_T i2c_pin)
{
    I2C_SCL_INIT();
    I2C_SDA_INIT_OUT();
    I2C_SCL_H();
